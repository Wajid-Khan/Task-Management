                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4">
                                    <div class="float-end d-none d-md-block">
                                        <div class="dropdown">
                                            <a class="btn btn-primary  dropdown-toggle" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#addDistrict">
                                                <i class="mdi mdi-plus me-2"></i> Add District
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                <?php $i=1; if(!empty($districts)): foreach($districts as $row): ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td><?php echo htmlentities($row->dist_name); ?></td>
                                                    <td><?php if($row->dist_status == 1): echo 'Active'; else: echo 'Inactive'; endif; ?></td>
                                                    <td>
                    ...
                    <div class="modal-body">
                        <form action="<?php echo base_url() ?>admin/setting/create_area" method="post">
                          <div class="mb-3 mt-3">
                            ...
                            <input type="text" class="form-control" id="area_name" placeholder="Enter category" name="area_name" value="<?php echo set_value('area_name') ?>" required>
