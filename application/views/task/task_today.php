                              ...
                              <div class="card-body table-responsive" >
                                ...
                                <table id="datatable" class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <tr class="fw-normal">
                                      <th>
                                        <span class=""><?php echo $obj->getClientName($task->cli_id); ?></span>
                                      </th>
                                      <?php if($user->role !== 'user'): ?>
                                      <th>
                                        <span class=""><?php echo $obj->getStaffName($task->staff_id); ?></span>
                                      </th>
                                      <?php endif; ?>
                                      ...
                                      <td class="align-middle">
                                        <span><?php echo $obj->timeAgo($task->created_at); ?></span>
                                      </td>
                                      <td class="align-middle">
                                        <a href="<?php echo base_url('task/detail/') . $task->task_id; ?>" data-mdb-toggle="tooltip" title="View"><i
                                            class="fas fa-eye text-success me-2"></i></a>
                                        <?php if($user->role !== 'user'): ?>
                                        <a href="<?php echo base_url('task/edit/') . $task->task_id; ?>" data-mdb-toggle="tooltip" title="Edit"><i
                                            class="fas fa-edit text-warning me-2"></i></a>
                                        <a href="javascript:void(0)" data-mdb-toggle="tooltip" task_id="<?php echo $task->task_id ?>" class="delete" title="Delete"><i
