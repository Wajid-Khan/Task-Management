                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4">
                                    <div class="float-end d-none d-md-block">
                                        <div class="dropdown">
                                            <a class="btn btn-primary  dropdown-toggle" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#addTaskCat">
                                                <i class="mdi mdi-plus me-2"></i> Add Task Category
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                <?php $i=1; if(!empty($category)): foreach($category as $row): ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td><?php echo $row->cat_name; ?></td>
                                                    <td><?php echo $row->cat_status; ?></td>
                                                    <td>
                                                        <a href="javascript:void(0)" class="text-warning edit" cat="<?php echo $row->cat_name ?>" cat_id="<?php echo $row->cat_id ?>" cat_status="<?php echo $row->cat_status ?>">
                                                            <span class="mdi mdi-lead-pencil"></span>
                                                        </a>
                                                        <a href="<?php echo base_url('category/delete/') . base64_encode($row->cat_id); ?>" class="text-danger delete">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo base_url() ?>category/create" method="post">
                          <div class="mb-3 mt-3">
                            ...
                            <input type="text" class="form-control" id="cat_name" placeholder="Enter category" name="cat_name" value="<?php echo set_value('cat_name') ?>" required>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo base_url() ?>category/update" method="post">
                          <div class="mb-3 mt-3">
                            <label for="task_cat_name" class="form-label">Category name</label>
                            <input type="text" class="form-control" id="cat_name_1" placeholder="Enter category" name="cat_name_1" value="<?php echo set_value('cat_name_1') ?>" required>
                            <?php echo form_error('cat_name_1'); ?>
                          </div>
        ...
        <script>
            $(document).ready(function(){
                ...
                $('.edit').click(function(){
                    ...
                    var select1 = '<label for="task_cat_name" class="form-label">Category Status</label><select class="form-control" name="cat_status_1" id="task_cat_status_1" required><option selected disabled value="">Select status</option><option value="Active" selected>Active</option><option value="Inactive">Inactive</option></select>';

                    var select2 = '<label for="task_cat_name" class="form-label">Category Status</label><select class="form-control" name="cat_status_1" id="task_cat_status_1" required><option selected disabled value="">Select status</option><option value="Active">Active</option><option value="Inactive" selected>Inactive</option></select>';
