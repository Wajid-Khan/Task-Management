...
<html lang="en">
    ...
    <body data-sidebar="dark">
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    ...
                    <div class="col-xl-9">
                        <div class="card">
                            <div class="card-body">
                                <form class="custom-validation" action="<?php echo base_url() ?>profile/update" method="post" >
                            <div class="row">
                                <div class="card">
                                    <div class="card-body">
        ...
        function uploadImage() {
            ...
            $.ajax({
                url: '<?php echo base_url() ?>profile/upload_image', // Change this to the actual URL
                type: 'POST',
                data: formData,
                dataType:'json',
                processData: false,
